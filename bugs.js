...
(() => {
  ...
  function createBugSvg() {
    return `
      <svg viewBox="0 0 24 24" width="22" height="22" fill="none" xmlns="http://www.w3.org/2000/svg">
        <!-- Antennae -->
        <path d="M8 6L5 2M16 6L19 2" stroke="#ef4444" stroke-width="1.5" stroke-linecap="round"/>
        <!-- Legs -->
        <path d="M4 10L1 9M4 14L1 15M4 18L1 20" stroke="#dc2626" stroke-width="1.5" stroke-linecap="round" class="bug-legs"/>
        <path d="M20 10L23 9M20 14L23 15M20 18L23 20" stroke="#dc2626" stroke-width="1.5" stroke-linecap="round" class="bug-legs"/>
        <!-- Shell / Body -->
        <ellipse cx="12" cy="14" rx="5.2" ry="6.2" fill="#991b1b" stroke="#ef4444" stroke-width="1"/>
        <line x1="12" y1="8" x2="12" y2="20" stroke="#dc2626" stroke-width="1"/>
        <!-- Head -->
  ...
  function createBurst(x, y) {
    const colors = ['#ef4444', '#dc2626', '#ef4444', '#ffffff'];
    for (let i = 0; i < 6; i++) {
